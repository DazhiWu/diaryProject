...
- [`docs/FACT_LAYER_PLAN.md`](docs/FACT_LAYER_PLAN.md): confirmed Phase 1 handoff state and the recommended administrator-only Fact Layer implementation plan.
