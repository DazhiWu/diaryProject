...
1. `POST /api/knowledge/answer` keeps administrator Cookie authorization, Origin checks, the shared interactive limiter, and ModelScope's existing per-attempt daily budget and fallback rules.
