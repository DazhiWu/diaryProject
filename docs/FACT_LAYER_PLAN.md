...
- Keep OpenAI SDK retries disabled. Factual-answer generation uses a 45-second timeout and an 8,000-token completion budget per configured model so reasoning models can emit final JSON; analysis and translation retain 30 seconds.
