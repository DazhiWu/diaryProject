...
4. A pre-migration status-only matrix: newest guest diary proxy `200`, sixth guest diary proxy `403`, old viewer diary proxy `200`, admin audio Range `206`, plus the observed direct-public object/list/write results.
