...
- Oversized JSON/multipart requests return `413`; invalid dates, field lengths, file types, arrays, or Ollama controls return `400` before downstream writes. ModelScope requests time out after 30 seconds; local Ollama requests time out after 120 seconds. The sixth interactive AI/translation/knowledge-search/factual-answer call in 60 seconds returns `429` for the same client IP.
